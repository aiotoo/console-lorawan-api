...
var file_external_service_device_proto_rawDesc = []byte{
	...
	0x65, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0x8d, 0x10,
	...
	0x2f, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x12, 0x6d, 0x0a, 0x0d, 0x55, 0x70, 0x6c, 0x6f,
	0x61, 0x64, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x12, 0x1a, 0x2e, 0x73, 0x65, 0x72, 0x76,
	...
	0x2d, 0x75, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x12, 0x5c, 0x0a, 0x03, 0x47, 0x65, 0x74, 0x12, 0x19,
...
var file_external_service_device_proto_depIdxs = []int32{
	...
	1,  // 33: service.DeviceService.UploadDevices:input_type -> service.BulkUploadRequest
	...
	2,  // 51: service.DeviceService.UploadDevices:output_type -> service.BulkUploadResponse
...
type DeviceServiceClient interface {
	...
	UploadDevices(ctx context.Context, in *BulkUploadRequest, opts ...grpc.CallOption) (*BulkUploadResponse, error)
...
func (c *deviceServiceClient) UploadDevices(ctx context.Context, in *BulkUploadRequest, opts ...grpc.CallOption) (*BulkUploadResponse, error) {
...
type DeviceServiceServer interface {
	...
	// Bulk upload devices from CSV.
	UploadDevices(context.Context, *BulkUploadRequest) (*BulkUploadResponse, error)
	// Get returns the device for the given DevEUI.
...
func (*UnimplementedDeviceServiceServer) UploadDevices(context.Context, *BulkUploadRequest) (*BulkUploadResponse, error) {
...
func _DeviceService_UploadDevices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeviceServiceServer).UploadDevices(ctx, req.(*BulkUploadRequest))
	}
	return interceptor(ctx, in, info, handler)
}
