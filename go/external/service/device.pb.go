...
type UploadRequest struct {
	...
	DeviceConfig *DeviceConfig `protobuf:"bytes,3,opt,name=device_config,json=deviceConfig,proto3" json:"device_config,omitempty"`
}
...
func (x *UploadRequest) GetDeviceConfig() *DeviceConfig {
	if x != nil {
...
type UploadResponse struct {
	...
	// CSV file name that was stored
	Filename string `protobuf:"bytes,1,opt,name=filename,proto3" json:"filename,omitempty"`
	// Upload status message
	Message string `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	// Number of devices processed
	DevicesProcessed int32 `protobuf:"varint,3,opt,name=devices_processed,json=devicesProcessed,proto3" json:"devices_processed,omitempty"`
}
...
func (x *UploadResponse) GetDevicesProcessed() int32 {
	if x != nil {
...
type UploadDataResponse struct {
	...
	// List of devices parsed from the CSV file
...
func (x *UploadDataResponse) GetDevices() []*Device {
	if x != nil {
		return x.Devices
	}
	return nil
...
func (x *BulkCreateDevicesResponse) GetSuccessCount() int32 {
	if x != nil {
...
func (x *BulkCreateDevicesResponse) GetFailureCount() int32 {
	if x != nil {
...
func (x *BulkCreateDevicesResponse) GetFailedDevices() []string {
	if x != nil {
...
type DeviceConfig struct {
	...
	// Supports OTAA.
	DeviceJoinMode util.JoinMode `protobuf:"varint,4,opt,name=device_join_mode,json=deviceJoinMode,proto3,enum=util.JoinMode" json:"device_join_mode,omitempty"`
	...
	FlushQueueOnActivate bool `protobuf:"varint,7,opt,name=flush_queue_on_activate,json=flushQueueOnActivate,proto3" json:"flush_queue_on_activate,omitempty"`
	// LoRaWAN mac-version.
	MacVersion util.MacVersion `protobuf:"varint,8,opt,name=mac_version,json=macVersion,proto3,enum=util.MacVersion" json:"mac_version,omitempty"`
	// Regional parameters revision.
	RegParamsRevision util.RegParamsRevision `protobuf:"varint,9,opt,name=reg_params_revision,json=regParamsRevision,proto3,enum=util.RegParamsRevision" json:"reg_params_revision,omitempty"`
	// ADR algorithm ID.
	AdrAlgorithmId string `protobuf:"bytes,10,opt,name=adr_algorithm_id,json=adrAlgorithmId,proto3" json:"adr_algorithm_id,omitempty"`
	// Payload codec runtime.
	PayloadCodecRuntime util.CodecRuntime `protobuf:"varint,11,opt,name=payload_codec_runtime,json=payloadCodecRuntime,proto3,enum=util.CodecRuntime" json:"payload_codec_runtime,omitempty"`
	// Class-B timeout (seconds).
	// This is the maximum time ChirpStack will wait to receive an acknowledgement
	// from the device (if requested).
	ClassBTimeout uint32 `protobuf:"varint,12,opt,name=class_b_timeout,json=classBTimeout,proto3" json:"class_b_timeout,omitempty"`
	...
	ClassBPingSlotDr uint32 `protobuf:"varint,14,opt,name=class_b_ping_slot_dr,json=classBPingSlotDr,proto3" json:"class_b_ping_slot_dr,omitempty"`
	// Class-B ping-slot freq (Hz).
	ClassBPingSlotFreq uint32 `protobuf:"varint,15,opt,name=class_b_ping_slot_freq,json=classBPingSlotFreq,proto3" json:"class_b_ping_slot_freq,omitempty"`
	// Class-C timeout (seconds).
	// This is the maximum time ChirpStack will wait to receive an acknowledgement
	// from the device (if requested).
	ClassCTimeout uint32 `protobuf:"varint,16,opt,name=class_c_timeout,json=classCTimeout,proto3" json:"class_c_timeout,omitempty"`
	// RX1 delay (for ABP).
	AbpRx1Delay uint32 `protobuf:"varint,17,opt,name=abp_rx1_delay,json=abpRx1Delay,proto3" json:"abp_rx1_delay,omitempty"`
...
func (x *DeviceConfig) GetRegion() util.Region {
	if x != nil {
		return x.Region
	}
...
func (x *DeviceConfig) GetRegionConfigId() string {
	if x != nil {
...
func (x *DeviceConfig) GetDeviceClass() util.DeviceClass {
	if x != nil {
...
func (x *DeviceConfig) GetDeviceJoinMode() util.JoinMode {
	if x != nil {
...
func (x *DeviceConfig) GetSkipFcntCheck() bool {
	if x != nil {
...
func (x *DeviceConfig) GetIsDisabled() bool {
	if x != nil {
		return x.IsDisabled
	}
	return false
...
func (x *DeviceConfig) GetFlushQueueOnActivate() bool {
	if x != nil {
...
func (x *DeviceConfig) GetMacVersion() util.MacVersion {
	if x != nil {
		return x.MacVersion
	}
...
func (x *DeviceConfig) GetRegParamsRevision() util.RegParamsRevision {
	if x != nil {
...
func (x *DeviceConfig) GetAdrAlgorithmId() string {
	if x != nil {
...
func (x *DeviceConfig) GetPayloadCodecRuntime() util.CodecRuntime {
	if x != nil {
...
func (x *DeviceConfig) GetClassBTimeout() uint32 {
	if x != nil {
...
func (x *DeviceConfig) GetClassBPingSlotNbK() uint32 {
	if x != nil {
...
func (x *DeviceConfig) GetClassBPingSlotDr() uint32 {
	if x != nil {
...
func (x *DeviceConfig) GetClassBPingSlotFreq() uint32 {
	if x != nil {
...
func (x *DeviceConfig) GetClassCTimeout() uint32 {
	if x != nil {
...
func (x *DeviceConfig) GetAbpRx1Delay() uint32 {
	if x != nil {
...
func (x *DeviceConfig) GetAbpRx1DrOffset() uint32 {
	if x != nil {
...
func (x *DeviceConfig) GetAbpRx2Dr() uint32 {
	if x != nil {
		return x.AbpRx2Dr
	}
	return 0
...
func (x *DeviceConfig) GetAbpRx2Freq() uint32 {
	if x != nil {
		return x.AbpRx2Freq
	}
	return 0
...
func (x *DeviceConfig) GetUplinkInterval() uint32 {
	if x != nil {
...
func (x *DeviceConfig) GetDeviceStatusReqInterval() uint32 {
	if x != nil {
...
func (x *DeviceConfig) GetFCntUp() uint32 {
	if x != nil {
		return x.FCntUp
	}
	return 0
...
func (x *DeviceConfig) GetNFCntDown() uint32 {
	if x != nil {
		return x.NFCntDown
	}
	return 0
...
func (x *DeviceConfig) GetAFCntDown() uint32 {
	if x != nil {
		return x.AFCntDown
	}
	return 0
...
var file_external_service_device_proto_rawDesc = []byte{
	...
	0x69, 0x63, 0x65, 0x22, 0x81, 0x01, 0x0a, 0x0d, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x52, 0x65,
	...
	0x28, 0x09, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x12, 0x3a, 0x0a, 0x0d, 0x64,
	0x65, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x15, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x44, 0x65, 0x76,
	0x69, 0x63, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x0c, 0x64, 0x65, 0x76, 0x69, 0x63,
	0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0x73, 0x0a, 0x0e, 0x55, 0x70, 0x6c, 0x6f, 0x61,
	...
	0x2b, 0x0a, 0x11, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x5f, 0x70, 0x72, 0x6f, 0x63, 0x65,
	0x73, 0x73, 0x65, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x10, 0x64, 0x65, 0x76, 0x69,
	0x63, 0x65, 0x73, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0
 0x6d, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x18, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x44, 0x65, 0x76, 0x69,
	...
	0x6c, 0x79, 0x22, 0x70, 0x0a, 0x1b, 0x47, 0x65, 0x74, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x51,
	...
	0x28, 0x0b, 0x32, 0x18, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x44, 0x65, 0x76,
	0x69, 0x63, 0x65, 0x51, 0x75, 0x65, 0x75, 0x65, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x06, 0x72, 0x65,
	0x73, 0x75, 0x6c, 0x74, 0x32, 0xec, 0x11, 0x0a, 0x0d, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x53,
	...
	0x60, 0x0a, 0x0a, 0x42, 0x75, 0x6c, 0x6b, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x12, 0x16, 0x2e,
	...
	0x82, 0xd3, 0xe4, 0x93, 0x02, 0x19, 0x22, 0x17, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x64, 0x65, 0x76,
	0x69, 0x63, 0x65, 0x73, 0x2f, 0x62, 0x75, 0x6c, 0x6b, 0x75, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x28,
	0x01, 0x12, 0x71, 0x0a, 0x0a, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x44, 0x61, 0x74, 0x61, 0x12,
	0x1a, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64,
	0x44, 0x61, 0x74, 0x61, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1b, 0x2e, 0x73, 0x65,
	...
	0x12, 0x22, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2f, 0x62,
	0x75, 0x6c, 0x6b, 0x75, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x2f, 0x7b, 0x66, 0x69, 0x6c, 0x65, 0x6e,
	0x61, 0x6d, 0x65, 0x7d, 0x12, 0x77, 0x0a, 0x0a, 0x42, 0x75, 0x6c, 0x6b, 0x43, 0x72, 0x65, 0x61,
	0x74, 0x65, 0x12, 0x21, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x42, 0x75, 0x6c,
	...
	0x65, 0x73, 0x2f, 0x62, 0x75, 0x6c, 0x6b, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x12, 0x5c, 0x0a,
	...
	0x65, 0x75, 0x65, 0x42, 0x3e, 0x5a, 0x3c, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_external_service_device_proto_msgTypes = make([]protoimpl.MessageInfo, 37)
var file_external_service_device_proto_goTypes = []any{
	...
	(*UploadResponse)(nil),                 // 2: service.UploadResponse
	(*UploadDataRequest)(nil),              // 3: service.UploadDataRequest
	(*UploadDataResponse)(nil),             // 4: service.UploadDataResponse
	(*BulkCreateDevicesRequest)(nil),       // 5: service.BulkCreateDevicesRequest
	(*BulkCreateDevicesResponse)(nil),      // 6: service.BulkCreateDevicesResponse
	(*DeviceConfig)(nil),                   // 7: service.DeviceConfig
	(*DeviceKeys)(nil),                     // 8: service.DeviceKeys
	(*DeviceActivation)(nil),               // 9: service.DeviceActivation
	(*Device)(nil),                         // 10: service.Device
	(*GetDeviceRequest)(nil),               // 11: service.GetDeviceRequest
	(*GetDeviceResponse)(nil),              // 12: service.GetDeviceResponse
	(*UpdateDeviceRequest)(nil),            // 13: service.UpdateDeviceRequest
	(*DeleteDeviceRequest)(nil),            // 14: service.DeleteDeviceRequest
	(*DeleteBulkDeviceRequest)(nil),        // 15: service.DeleteBulkDeviceRequest
	(*ListDevicesRequest)(nil),             // 16: service.ListDevicesRequest
	(*ListDevicesResponse)(nil),            // 17: service.ListDevicesResponse
	(*DeviceListItem)(nil),                 // 18: service.DeviceListItem
	(*UpdateDeviceKeysRequest)(nil),        // 19: service.UpdateDeviceKeysRequest
	(*FlushDevNoncesRequest)(nil),          // 20: service.FlushDevNoncesRequest
	(*ActivateDeviceRequest)(nil),          // 21: service.ActivateDeviceRequest
	(*DeactivateDeviceRequest)(nil),        // 22: service.DeactivateDeviceRequest
	(*GetDeviceActivationRequest)(nil),     // 23: service.GetDeviceActivationRequest
	(*GetDeviceActivationResponse)(nil),    // 24: service.GetDeviceActivationResponse
	(*CreateDeviceKeysRequest)(nil),        // 25: service.CreateDeviceKeysRequest
	(*GetDeviceKeysRequest)(nil),           // 26: service.GetDeviceKeysRequest
	(*GetDeviceKeysResponse)(nil),          // 27: service.GetDeviceKeysResponse
	(*DeleteDeviceKeysRequest)(nil),        // 28: service.DeleteDeviceKeysRequest
	(*DeviceQueueItem)(nil),                // 29: service.DeviceQueueItem
	(*EnqueueDeviceQueueItemRequest)(nil),  // 30: service.EnqueueDeviceQueueItemRequest
	(*EnqueueDeviceQueueItemResponse)(nil), // 31: service.EnqueueDeviceQueueItemResponse
	(*FlushDeviceQueueRequest)(nil),        // 32: service.FlushDeviceQueueRequest
	(*GetDeviceQueueItemsRequest)(nil),     // 33: service.GetDeviceQueueItemsRequest
	(*GetDeviceQueueItemsResponse)(nil),    // 34: service.GetDeviceQueueItemsResponse
	nil,                                    // 35: service.Device.VariablesEntry
	nil,                                    // 36: service.Device.TagsEntry
	(util.Region)(0),                       // 37: util.Region
	(util.DeviceClass)(0),                  // 38: util.DeviceClass
	(util.JoinMode)(0),                     // 39: util.JoinMode
	(util.MacVersion)(0),                   // 40: util.MacVersion
	(util.RegParamsRevision)(0),            // 41: util.RegParamsRevision
	(util.CodecRuntime)(0),                 // 42: util.CodecRuntime
	(*timestamppb.Timestamp)(nil),          // 43: google.protobuf.Timestamp
	(*structpb.Struct)(nil),                // 44: google.protobuf.Struct
	(*emptypb.Empty)(nil),                  // 45: google.protobuf.Empty
}
var file_external_service_device_proto_depIdxs = []int32{
	10, // 0: service.CreateDeviceRequest.device:type_name -> service.Device
	7,  // 1: service.UploadRequest.device_config:type_name -> service.DeviceConfig
	10, // 2: service.UploadDataResponse.devices:type_name -> service.Device
	10, // 3: service.BulkCreateDevicesRequest.devices:type_name -> service.Device
	37, // 4: service.DeviceConfig.region:type_name -> util.Region
	38, // 5: service.DeviceConfig.device_class:type_name -> util.DeviceClass
	39, // 6: service.DeviceConfig.device_join_mode:type_name -> util.JoinMode
	40, // 7: service.DeviceConfig.mac_version:type_name -> util.MacVersion
	41, // 8: service.DeviceConfig.reg_params_revision:type_name -> util.RegParamsRevision
	42, // 9: service.DeviceConfig.payload_codec_runtime:type_name -> util.CodecRuntime
	35, // 10: service.Device.variables:type_name -> service.Device.VariablesEntry
	36, // 11: service.Device.tags:type_name -> service.Device.TagsEntry
	38, // 12: service.Device.device_class:type_name -> util.DeviceClass
	39, // 13: service.Device.device_join_mode:type_name -> util.JoinMode
	8,  // 14: service.Device.keys:type_name -> service.DeviceKeys
	9,  // 15: service.Device.device_activation:type_name -> service.DeviceActivation
	37, // 16: service.Device.region:type_name -> util.Region
	40, // 17: service.Device.mac_version:type_name -> util.MacVersion
	41, // 18: service.Device.reg_params_revision:type_name -> util.RegParamsRevision
	42, // 19: service.Device.payload_codec_runtime:type_name -> util.CodecRuntime
	10, // 20: service.GetDeviceResponse.device:type_name -> service.Device
	43, // 21: service.GetDeviceResponse.created_at:type_name -> google.protobuf.Timestamp
	43, // 22: service.GetDeviceResponse.updated_at:type_name -> google.protobuf.Timestamp
	43, // 23: service.GetDeviceResponse.last_seen_at:type_name -> google.protobuf.Timestamp
	10, // 24: service.UpdateDeviceRequest.device:type_name -> service.Device
	18, // 25: service.ListDevicesResponse.result:type_name -> service.DeviceListItem
	43, // 26: service.DeviceListItem.created_at:type_name -> google.protobuf.Timestamp
	43, // 27: service.DeviceListItem.updated_at:type_name -> google.protobuf.Timestamp
	43, // 28: service.DeviceListItem.last_seen_at:type_name -> google.protobuf.Timestamp
	8,  // 29: service.UpdateDeviceKeysRequest.device_keys:type_name -> service.DeviceKeys
	9,  // 30: service.ActivateDeviceRequest.device_activation:type_name -> service.DeviceActivation
	9,  // 31: service.GetDeviceActivationResponse.device_activation:type_name -> service.DeviceActivation
	8,  // 32: service.CreateDeviceKeysRequest.device_keys:type_name -> service.DeviceKeys
	8,  // 33: service.GetDeviceKeysResponse.device_keys:type_name -> service.DeviceKeys
	43, // 34: service.GetDeviceKeysResponse.created_at:type_name -> google.protobuf.Timestamp
	43, // 35: service.GetDeviceKeysResponse.updated_at:type_name -> google.protobuf.Timestamp
	44, // 36: service.DeviceQueueItem.object:type_name -> google.protobuf.Struct
	43, // 37: service.DeviceQueueItem.expires_at:type_name -> google.protobuf.Timestamp
	29, // 38: service.EnqueueDeviceQueueItemRequest.queue_item:type_name -> service.DeviceQueueItem
	29, // 39: service.GetDeviceQueueItemsResponse.result:type_name -> service.DeviceQueueItem
	0,  // 40: service.DeviceService.Create:input_type -> service.CreateDeviceRequest
	1,  // 41: service.DeviceService.BulkUpload:input_type -> service.UploadRequest
	3,  // 42: service.DeviceService.UploadData:input_type -> service.UploadDataRequest
	5,  // 43: service.DeviceService.BulkCreate:input_type -> service.BulkCreateDevicesRequest
	11, // 44: service.DeviceService.Get:input_type -> service.GetDeviceRequest
	13, // 45: service.DeviceService.Update:input_type -> service.UpdateDeviceRequest
	14, // 46: service.DeviceService.Delete:input_type -> service.DeleteDeviceRequest
	15, // 47: service.DeviceService.DeleteBulkDevice:input_type -> service.DeleteBulkDeviceRequest
	16, // 48: service.DeviceService.List:input_type -> service.ListDevicesRequest
	25, // 49: service.DeviceService.CreateKeys:input_type -> service.CreateDeviceKeysRequest
	26, // 50: service.DeviceService.GetKeys:input_type -> service.GetDeviceKeysRequest
	19, // 51: service.DeviceService.UpdateKeys:input_type -> service.UpdateDeviceKeysRequest
	28, // 52: service.DeviceService.DeleteKeys:input_type -> service.DeleteDeviceKeysRequest
	20, // 53: service.DeviceService.FlushDevNonces:input_type -> service.FlushDevNoncesRequest
	21, // 54: service.DeviceService.Activate:input_type -> service.ActivateDeviceRequest
	22, // 55: service.DeviceService.Deactivate:input_type -> service.DeactivateDeviceRequest
	23, // 56: service.DeviceService.GetActivation:input_type -> service.GetDeviceActivationRequest
	30, // 57: service.DeviceService.Enqueue:input_type -> service.EnqueueDeviceQueueItemRequest
	32, // 58: service.DeviceService.FlushQueue:input_type -> service.FlushDeviceQueueRequest
	33, // 59: service.DeviceService.GetQueue:input_type -> service.GetDeviceQueueItemsRequest
	45, // 60: service.DeviceService.Create:output_type -> google.protobuf.Empty
	2,  // 61: service.DeviceService.BulkUpload:output_type -> service.UploadResponse
	4,  // 62: service.DeviceService.UploadData:output_type -> service.UploadDataResponse
	6,  // 63: service.DeviceService.BulkCreate:output_type -> service.BulkCreateDevicesResponse
	12, // 64: service.DeviceService.Get:output_type -> service.GetDeviceResponse
	45, // 65: service.DeviceService.Update:output_type -> google.protobuf.Empty
	45, // 66: service.DeviceService.Delete:output_type -> google.protobuf.Empty
	45, // 67: service.DeviceService.DeleteBulkDevice:output_type -> google.protobuf.Empty
	17, // 68: service.DeviceService.List:output_type -> service.ListDevicesResponse
	45, // 69: service.DeviceService.CreateKeys:output_type -> google.protobuf.Empty
	27, // 70: service.DeviceService.GetKeys:output_type -> service.GetDeviceKeysResponse
	45, // 71: service.DeviceService.UpdateKeys:output_type -> google.protobuf.Empty
	45, // 72: service.DeviceService.DeleteKeys:output_type -> google.protobuf.Empty
	45, // 73: service.DeviceService.FlushDevNonces:output_type -> google.protobuf.Empty
	45, // 74: service.DeviceService.Activate:output_type -> google.protobuf.Empty
	45, // 75: service.DeviceService.Deactivate:output_type -> google.protobuf.Empty
	24, // 76: service.DeviceService.GetActivation:output_type -> service.GetDeviceActivationResponse
	31, // 77: service.DeviceService.Enqueue:output_type -> service.EnqueueDeviceQueueItemResponse
	45, // 78: service.DeviceService.FlushQueue:output_type -> google.protobuf.Empty
	34, // 79: service.DeviceService.GetQueue:output_type -> service.GetDeviceQueueItemsResponse
...
type DeviceServiceClient interface {
	...
	// Get processed CSV data for a specific file.
	UploadData(ctx context.Context, in *UploadDataRequest, opts ...grpc.CallOption) (*UploadDataResponse, error)
	// Bulk create devices
	BulkCreate(ctx context.Context, in *BulkCreateDevicesRequest, opts ...grpc.CallOption) (*BulkCreateDevicesResponse, error)
...
func (c *deviceServiceClient) UploadData(ctx context.Context, in *UploadDataRequest, opts ...grpc.CallOption) (*UploadDataResponse, error) {
	out := new(UploadDataResponse)
	err := c.cc.Invoke(ctx, "/service.DeviceService/UploadData", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deviceServiceClient) BulkCreate(ctx context.Context, in *BulkCreateDevicesRequest, opts ...grpc.CallOption) (*BulkCreateDevicesResponse, error) {
	out := new(BulkCreateDevicesResponse)
	err := c.cc.Invoke(ctx, "/service.DeviceService/BulkCreate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DeviceServiceServer interface {
	...
	// Bulk create devices
	BulkCreate(context.Context, *BulkCreateDevicesRequest) (*BulkCreateDevicesResponse, error)
	// Get returns the device for the given DevEUI.
...
func (*UnimplementedDeviceServiceServer) UploadData(context.Context, *UploadDataRequest) (*UploadDataResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UploadData not implemented")
}
func (*UnimplementedDeviceServiceServer) BulkCreate(context.Context, *BulkCreateDevicesRequest) (*BulkCreateDevicesResponse, error) {
...
func _DeviceService_UploadData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UploadDataRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DeviceServiceServer).UploadData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.DeviceService/UploadData",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeviceServiceServer).UploadData(ctx, req.(*UploadDataRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _DeviceService_BulkCreate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BulkCreateDevicesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DeviceServiceServer).BulkCreate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.DeviceService/BulkCreate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeviceServiceServer).BulkCreate(ctx, req.(*BulkCreateDevicesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _DeviceService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _DeviceService_UploadData_Handler,
		},
		{
			MethodName: "BulkCreate",
			Handler:    _DeviceService_BulkCreate_Handler,
		},
		{
			MethodName: "Get",
