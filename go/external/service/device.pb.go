...
var file_external_service_device_proto_rawDesc = []byte{
	...
	0x69, 0x63, 0x65, 0x22, 0x29, 0x0a, 0x0d, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0x46,
	...
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x13, 0x0a, 0x11, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64,
	0x44, 0x61, 0x74, 0x61, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x3f, 0x0a, 0x12, 0x55,
	0x70, 0x6c, 0x6f, 0x61, 0x64, 0x44, 0x61, 0x74, 0x61, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x12, 0x29, 0x0a, 0x07, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x44, 0x65, 0x76,
	0x69, 0x63, 0x65, 0x52, 0x07, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x22, 0x57, 0x0a, 0x0a,
	...
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0xef, 0x10, 0x0a, 0x0d, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65,
	...
	0x12, 0x61, 0x0a, 0x0a, 0x42, 0x75, 0x6c, 0x6b, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x12, 0x16,
	...
	0x2f, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2f, 0x62, 0x75, 0x6c, 0x6b, 0x75, 0x70, 0x6c,
	0x6f, 0x61, 0x64, 0x12, 0x6c, 0x0a, 0x0a, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x44, 0x61, 0x74,
	0x61, 0x12, 0x1a, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x55, 0x70, 0x6c, 0x6f,
	0x61, 0x64, 0x44, 0x61, 0x74, 0x61, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1b, 0x2e,
	...
	0x2f, 0x62, 0x75, 0x6c, 0x6b, 0x2d, 0x75, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x2d, 0x64, 0x61, 0x74,
	0x61, 0x12, 0x5c, 0x0a, 0x03, 0x47, 0x65, 0x74, 0x12, 0x19, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69,
...
var file_external_service_device_proto_depIdxs = []int32{
	...
	7,  // 1: service.UploadDataResponse.devices:type_name -> service.Device
	...
	1,  // 33: service.DeviceService.BulkUpload:input_type -> service.UploadRequest
	3,  // 34: service.DeviceService.UploadData:input_type -> service.UploadDataRequest
	...
	2,  // 52: service.DeviceService.BulkUpload:output_type -> service.UploadResponse
	4,  // 53: service.DeviceService.UploadData:output_type -> service.UploadDataResponse
...
type DeviceServiceClient interface {
	...
	// Upload CSV file
	BulkUpload(ctx context.Context, in *UploadRequest, opts ...grpc.CallOption) (*UploadResponse, error)
...
func (c *deviceServiceClient) BulkUpload(ctx context.Context, in *UploadRequest, opts ...grpc.CallOption) (*UploadResponse, error) {
	out := new(UploadResponse)
	err := c.cc.Invoke(ctx, "/service.DeviceService/BulkUpload", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DeviceServiceServer interface {
	...
	// Upload CSV file
	BulkUpload(context.Context, *UploadRequest) (*UploadResponse, error)
	// Get processed CSV data
...
func (*UnimplementedDeviceServiceServer) BulkUpload(context.Context, *UploadRequest) (*UploadResponse, error) {
...
func _DeviceService_BulkUpload_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UploadRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DeviceServiceServer).BulkUpload(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.DeviceService/BulkUpload",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeviceServiceServer).BulkUpload(ctx, req.(*UploadRequest))
	}
	return interceptor(ctx, in, info, handler)
}
