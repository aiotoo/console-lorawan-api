...
var file_external_service_mqtt_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0x9b, 0x02, 0x0a, 0x0d, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65,
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x52, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12,
	0x18, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x4d, 0x71, 0x74, 0x74, 0x41, 0x75,
	0x74, 0x68, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x19, 0x2e, 0x73, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x2e, 0x4d, 0x71, 0x74, 0x74, 0x41, 0x75, 0x74, 0x68, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x15, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x0f, 0x3a, 0x01, 0x2a, 0x22,
	0x0a, 0x2f, 0x6d, 0x71, 0x74, 0x74, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x12, 0x66, 0x0a, 0x09, 0x53,
	...
	0x01, 0x2a, 0x22, 0x0f, 0x2f, 0x6d, 0x71, 0x74, 0x74, 0x2f, 0x73, 0x75, 0x70, 0x65, 0x72, 0x75,
	0x73, 0x65, 0x72, 0x12, 0x4e, 0x0a, 0x03, 0x41, 0x63, 0x6c, 0x12, 0x17, 0x2e, 0x73, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x2e, 0x4d, 0x71, 0x74, 0x74, 0x41, 0x63, 0x6c, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x18, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x4d, 0x71,
	0x74, 0x74, 0x41, 0x63, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x14, 0x82,
	0xd3, 0xe4, 0x93, 0x02, 0x0e, 0x3a, 0x01, 0x2a, 0x22, 0x09, 0x2f, 0x6d, 0x71, 0x74, 0x74, 0x2f,
	0x61, 0x63, 0x6c, 0x42, 0x3e, 0x5a, 0x3c, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_external_service_mqtt_proto_depIdxs = []int32{
	0, // 0: service.DeviceService.Auth:input_type -> service.MqttAuthRequest
	2, // 1: service.DeviceService.SuperUser:input_type -> service.MqttSuperuserRequest
	4, // 2: service.DeviceService.Acl:input_type -> service.MqttAclRequest
	1, // 3: service.DeviceService.Auth:output_type -> service.MqttAuthResponse
	3, // 4: service.DeviceService.SuperUser:output_type -> service.MqttSuperuserResponse
	5, // 5: service.DeviceService.Acl:output_type -> service.MqttAclResponse
...
func (c *deviceServiceClient) Auth(ctx context.Context, in *MqttAuthRequest, opts ...grpc.CallOption) (*MqttAuthResponse, error) {
	out := new(MqttAuthResponse)
	err := c.cc.Invoke(ctx, "/service.DeviceService/Auth", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deviceServiceClient) SuperUser(ctx context.Context, in *MqttSuperuserRequest, opts ...grpc.CallOption) (*MqttSuperuserResponse, error) {
	out := new(MqttSuperuserResponse)
	err := c.cc.Invoke(ctx, "/service.DeviceService/SuperUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deviceServiceClient) Acl(ctx context.Context, in *MqttAclRequest, opts ...grpc.CallOption) (*MqttAclResponse, error) {
	out := new(MqttAclResponse)
	err := c.cc.Invoke(ctx, "/service.DeviceService/Acl", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedDeviceServiceServer) Auth(context.Context, *MqttAuthRequest) (*MqttAuthResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Auth not implemented")
}
func (*UnimplementedDeviceServiceServer) SuperUser(context.Context, *MqttSuperuserRequest) (*MqttSuperuserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SuperUser not implemented")
}
func (*UnimplementedDeviceServiceServer) Acl(context.Context, *MqttAclRequest) (*MqttAclResponse, error) {
...
func _DeviceService_Auth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MqttAuthRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DeviceServiceServer).Auth(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.DeviceService/Auth",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeviceServiceServer).Auth(ctx, req.(*MqttAuthRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _DeviceService_SuperUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MqttSuperuserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DeviceServiceServer).SuperUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.DeviceService/SuperUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeviceServiceServer).SuperUser(ctx, req.(*MqttSuperuserRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _DeviceService_Acl_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MqttAclRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DeviceServiceServer).Acl(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.DeviceService/Acl",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeviceServiceServer).Acl(ctx, req.(*MqttAclRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _DeviceService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Auth",
			Handler:    _DeviceService_Auth_Handler,
		},
		{
			MethodName: "SuperUser",
			Handler:    _DeviceService_SuperUser_Handler,
		},
		{
			MethodName: "Acl",
			Handler:    _DeviceService_Acl_Handler,
		},
	},
