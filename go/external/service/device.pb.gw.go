...
var (
	...
	pattern_DeviceService_UploadDevices_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "devices", "bulk-upload"}, "", runtime.AssumeColonVerbOpt(true)))
